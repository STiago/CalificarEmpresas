...
formu_empresa = form.Form(
	form.Textbox("Empresa", form.notnull, description = 'Introduzca el nombre de la empresa'),
	form.Textbox("Alumno", form.notnull, description = 'Introduzca el nombre del alumno'),
	form.Textbox("Calificacion", form.notnull, description = 'Introduzca la calificación'),
	form.Button("Enviar")
)
...
class inserta:
    ...
    def POST(self):
		...
		if not form.validates():
			...
			nombres = {"Empresa": form.d.Nombre,
				    "Alumno": form.d.Apellidos,
				    "Calificacion": form.d.dia,
				    }
